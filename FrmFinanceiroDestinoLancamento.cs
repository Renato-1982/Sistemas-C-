...
namespace SIGRas
{
    public partial class FrmFinanceiroDestinoLancamento : Form
    {
        public FrmFinanceiroDestinoLancamento()
        {
            InitializeComponent();
        }
        ...
        public void preencheListView(string strSql, string tstr)
        {
            ...
            try
            {
                ...
                while (datareader.Read())
                {
                    ...
                    lvw_lancamento.Items.Add(lvitem);
                }
        ...
        private void preencheTexto(string strSql, string tstr)
        {
            ...
            datareader.Read();
            {
                ...
                txt_descricaolancamento.Text = datareader["DescricaoLancamentos"].ToString();
        ...
        private void desabilita(bool a)
        {
            #region 'DESABILITA'
            txt_id.Enabled = a;
            txt_descricaolancamento.Enabled = a;
            txt_obs.Enabled = a;
            #endregion
        }
        #endregion
        ...
        private void FrmFinanceiroDestinoLancamento_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FrmFinanceiroDestinoLancamento_Load(object sender, EventArgs e)
        {
            #region 'CARREGA AS COMBOBOX'
            //CARREGAR COMBOBOX PROCURAR
            this.cbo_procurar.Items.Clear();
            this.cbo_procurar.Items.Add("ID");
            this.cbo_procurar.Items.Add("DescricaoLancamentos");
            ...
            try
            {
                string strSQL = "Select * from tb_financeirodestinolancamentos order by ID";
                ...
                this.txt_descricaolancamento.Enabled = false;
        ...
        private void btn_novo_Click(object sender, EventArgs e)
        {
            ...
            //LIMPAR CAIXAS
            this.txt_id.Text = "";
            this.txt_descricaolancamento.Text = "";
            this.txt_obs.Text = "";
            this.cbo_procurar.Text = "";
            this.txt_procurar.Text = "";
            #endregion
        ...
        private void btn_gravar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Connection = ClasseBDConexao.abrir(); //Abre a conexão
                cmd.CommandText = "Insert Into tb_financeirodestinolancamentos(DescricaoLancamentos,Observacoes) Values";
                cmd.CommandText += "('" + txt_descricaolancamento.Text + "','" + txt_obs.Text + "')";
                cmd.ExecuteNonQuery();
                cmd.Connection.Close(); //Fecha a conexão
                #endregion

                #region 'MENSAGEM'
                MessageBox.Show("Descrição Lançamento Cadastrado com Sucesso!!!");
                #endregion
            ...
            FrmFinanceiroDestinoLancamento_Load(sender, e);
            #endregion
        ...
        private void btn_alterar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand();
                cmd.Connection = ClasseBDConexao.abrir(); //Abre a conexão
                cmd.CommandText = "update tb_financeirodestinolancamentos set DescricaoLancamentos ='" + txt_descricaolancamento.Text + "' ,Observacoes = '" + txt_obs.Text + "' Where ID = " + txt_id.Text + "";
                cmd.ExecuteNonQuery();
                cmd.Connection.Close(); //Fecha a conexão
                #endregion
        ...
        private void btn_cancelar_Click(object sender, EventArgs e)
        {
            ...
            this.lvw_lancamento.Enabled = true;
            #endregion
            ...
            try
            {
                string str = "Select * from tb_financeirodestinolancamentos order by ID";
                string tstr = "tb_financeirodestinolancamentos";
        ...
        private void txt_procurar_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string strSQL = "Select * from tb_financeirodestinolancamentos " + "where " + cbo_procurar.Text + " like'%" + txt_procurar.Text + "%'";
                string tstr = "tb_financeirodestinolancamentos";
                preencheListView(strSQL, tstr);
        ...
        private void lvw_lancamento_SelectedIndexChanged(object sender, EventArgs e)
        {
            #region 'CARREGA OS DADOS DO BANCO NA LISTVIEW'
            //CARREGA AS CAIXAS
            txt_id.Text = (lvw_lancamento.Items[lvw_lancamento.FocusedItem.Index].SubItems[0].Text);
            txt_descricaolancamento.Text = (lvw_lancamento.Items[lvw_lancamento.FocusedItem.Index].SubItems[1].Text);
            txt_obs.Text = (lvw_lancamento.Items[lvw_lancamento.FocusedItem.Index].SubItems[2].Text);
            #endregion
