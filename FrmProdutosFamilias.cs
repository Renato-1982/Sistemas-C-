...
namespace SIGRas
{
    public partial class FrmProdutosFamilias : Form
    {
        public FrmProdutosFamilias()
        {
            InitializeComponent();
        }
        ...
        private void preencheTexto(string strSql, string tstr)
        {
            ...
            datareader.Read();
            {
                ...
                txt_descricaofamilia.Text = datareader["DescricaoFamilia"].ToString();
        ...
        private void desabilita(bool a)
        {
            #region 'DESABILITA'
            txt_id.Enabled = a;
            txt_descricaofamilia.Enabled = a;
            txt_obs.Enabled = a;
            #endregion
        }
        #endregion
        ...
        private void FrmProdutosFamilias_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FrmProdutosFamilias_Load(object sender, EventArgs e)
        {
            #region 'CARREGAR COMBOBOX'
            this.cbo_procurar.Items.Clear();
            this.cbo_procurar.Items.Add("ID");
            this.cbo_procurar.Items.Add("DescricaoFamilia");
            ...
            try
            {
                string strSQL = "Select * from tb_produtosfamilias order by ID";
                ...
                this.txt_descricaofamilia.Enabled = false;
        ...
        private void btn_novo_Click(object sender, EventArgs e)
        {
            ...
            this.txt_id.Text = "";
            this.txt_descricaofamilia.Text = "";
            this.txt_obs.Text = "";
            this.cbo_procurar.Text = "";
            this.txt_procurar.Text = "";
            #endregion
        ...
        private void btn_gravar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Connection = ClasseBDConexao.abrir(); //Abre a conexão
                cmd.CommandText = "Insert Into tb_produtosfamilias(DescricaoFamilia,Observacoes) Values";
                cmd.CommandText += "('" + txt_descricaofamilia.Text + "','" + txt_obs.Text + "')";
                cmd.ExecuteNonQuery();
                cmd.Connection.Close(); //Fecha a conexão
                #endregion
            ...
            FrmProdutosFamilias_Load(sender, e);
            #endregion
        ...
        private void btn_alterar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand();
                cmd.Connection = ClasseBDConexao.abrir(); //Abre a conexão
                cmd.CommandText = "update tb_produtosfamilias set DescricaoFamilia ='" + txt_descricaofamilia.Text + "' ,Observacoes = '" + txt_obs.Text + "' Where ID = " + txt_id.Text + "";
                cmd.ExecuteNonQuery();
                cmd.Connection.Close(); //Fecha a conexão
                #endregion
        ...
        private void btn_cancelar_Click(object sender, EventArgs e)
        {
            ...
            this.lvw_familias.Enabled = true;
            #endregion
            ...
            try
            {
                string str = "Select * from tb_produtosfamilias order by ID";
                string tstr = "tb_produtosfamilias";
        ...
        private void txt_procurar_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string strSQL = "Select * from tb_produtosfamilias " + "where " + cbo_procurar.Text + " like'%" + txt_procurar.Text + "%'";
                string tstr = "tb_produtosfamilias";
                preencheListView(strSQL, tstr);
        ...
        private void lvw_familias_SelectedIndexChanged(object sender, EventArgs e)
        {
            #region 'CARREGA AS CAIXAS SELECIONANDO O LISTVIEW'
            txt_id.Text = (lvw_familias.Items[lvw_familias.FocusedItem.Index].SubItems[0].Text);
            txt_descricaofamilia.Text = (lvw_familias.Items[lvw_familias.FocusedItem.Index].SubItems[1].Text);
            txt_obs.Text = (lvw_familias.Items[lvw_familias.FocusedItem.Index].SubItems[2].Text);
            #endregion
