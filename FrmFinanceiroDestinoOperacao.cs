...
namespace SIGRas
{
    public partial class FrmFinanceiroDestinoOperacao : Form
    {
        public FrmFinanceiroDestinoOperacao()
        {
            InitializeComponent();
        }
        ...
        public void preencheListView(string strSql, string tstr)
        {
            ...
            lvw_destinooperacao.Items.Clear();
            ...
            try
            {
                ...
                while (datareader.Read())
                {
                    ...
                    lvw_destinooperacao.Items.Add(lvitem);
                }
        ...
        private void preencheTexto(string strSql, string tstr)
        {
            ...
            datareader.Read();
            {
                ...
                txt_descricaodestino.Text = datareader["DescricaoDestinos"].ToString();
        ...
        private void desabilita(bool a)
        {
            #region 'DESABILITA'
            txt_id.Enabled = a;
            txt_descricaodestino.Enabled = a;
            txt_obs.Enabled = a;
            #endregion
        }
        #endregion
        ...
        private void FrmFinanceiroDestinoOperacao_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FrmFinanceiroDestinoOperacao_Load(object sender, EventArgs e)
        {
            #region 'CARREGA AS COMBOBOX'
            //CARREGAR COMBOBOX PROCURAR
            this.cbo_procurar.Items.Clear();
            this.cbo_procurar.Items.Add("ID");
            this.cbo_procurar.Items.Add("DescricaoDestinos");
            ...
            try
            {
                string strSQL = "Select * from tb_financeirodestinooperacao order by ID";
                ...
                this.txt_descricaodestino.Enabled = false;
        ...
        private void btn_novo_Click(object sender, EventArgs e)
        {
            ...
            //LIMPAR CAIXAS
            this.txt_id.Text = "";
            this.txt_descricaodestino.Text = "";
            this.txt_obs.Text = "";
            this.cbo_procurar.Text = "";
            this.txt_procurar.Text = "";
            #endregion
        ...
        private void btn_gravar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Connection = ClasseBDConexao.abrir(); //Abre a conexão
                cmd.CommandText = "Insert Into tb_financeirodestinooperacao(DescricaoDestinos,Observacoes) Values";
                cmd.CommandText += "('" + txt_descricaodestino.Text + "','" + txt_obs.Text + "')";
                cmd.ExecuteNonQuery();
                cmd.Connection.Close(); //Fecha a conexão
                #endregion

                #region 'MENSAGEM'
                MessageBox.Show("Descrição Destino Operação Cadastrado com Sucesso!!!");
                #endregion
            ...
            FrmFinanceiroDestinoOperacao_Load(sender, e);
            #endregion
        ...
        private void btn_alterar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand();
                cmd.Connection = ClasseBDConexao.abrir(); //Abre a conexão
                cmd.CommandText = "update tbl_dadosfinanceirodestinooperacao set DescricaoDestinos ='" + txt_descricaodestino.Text + "' ,Observacoes = '" + txt_obs.Text + "' Where ID = " + txt_id.Text + "";
                cmd.ExecuteNonQuery();
                cmd.Connection.Close(); //Fecha a conexão
                #endregion
        ...
        private void btn_cancelar_Click(object sender, EventArgs e)
        {
            ...
            this.lvw_destinooperacao.Enabled = true;
            #endregion
            ...
            try
            {
                string str = "Select * from tb_financeirodestinooperacao order by ID";
                string tstr = "tb_financeirodestinooperacao";
        ...
        private void txt_procurar_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string strSQL = "Select * from tb_financeirodestinooperacao " + "where " + cbo_procurar.Text + " like'%" + txt_procurar.Text + "%'";
                string tstr = "tb_financeirodestinooperacao";
                preencheListView(strSQL, tstr);
        ...
        private void lvw_destinooperacao_SelectedIndexChanged(object sender, EventArgs e)
        {
            #region 'CARREGA OS DADOS DO BANCO NA LISTVIEW'
            //CARREGA AS CAIXAS
            txt_id.Text = (lvw_destinooperacao.Items[lvw_destinooperacao.FocusedItem.Index].SubItems[0].Text);
            txt_descricaodestino.Text = (lvw_destinooperacao.Items[lvw_destinooperacao.FocusedItem.Index].SubItems[1].Text);
            txt_obs.Text = (lvw_destinooperacao.Items[lvw_destinooperacao.FocusedItem.Index].SubItems[2].Text);
            #endregion
