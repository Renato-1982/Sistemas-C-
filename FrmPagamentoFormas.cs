...
namespace SIGRas
{
    public partial class FrmPagamentoFormas : Form
    {
        public FrmPagamentoFormas()
        {
            InitializeComponent();
        }
        ...
        public void preencheListView(string strSql, string tstr)
        {
            ...
            lvw_formaspagamento.Items.Clear();
            ...
            try
            {
                ...
                while (datareader.Read())
                {
                    ...
                    lvw_formaspagamento.Items.Add(lvitem);
                }
        ...
        private void preencheTexto(string strSql, string tstr)
        {
            ...
            datareader.Read();
            {
                ...
                txt_descricaoformapagamento.Text = datareader["DescricaoFormasPagamento"].ToString();
        ...
        private void desabilita(bool a)
        {
            #region 'DESABILITA'
            txt_id.Enabled = a;
            txt_descricaoformapagamento.Enabled = a;
            txt_obs.Enabled = a;
            #endregion
        }
        #endregion
        ...
        private void FrmPagamentoFormas_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FrmPagamentoFormas_Load(object sender, EventArgs e)
        {
            #region 'CARREGAR COMBOBOX'
            this.cbo_procurar.Items.Clear();
            this.cbo_procurar.Items.Add("ID");
            this.cbo_procurar.Items.Add("DescricaoFormasPagamento");
            ...
            try
            {
                string strSQL = "Select * from tb_formaspagamento order by ID";
                ...
                this.txt_descricaoformapagamento.Enabled = false;
        ...
        private void btn_novo_Click(object sender, EventArgs e)
        {
            ...
            this.txt_id.Text = "";
            this.txt_descricaoformapagamento.Text = "";
            this.txt_obs.Text = "";
            this.cbo_procurar.Text = "";
            this.txt_procurar.Text = "";
            #endregion
            ...
            #region 'COLOCA O FOCO'
            //POSICIONA DENTRO DA CAIXA
            txt_descricaoformapagamento.Focus();
            #endregion
        }
        ...
        private void btn_gravar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Connection = ClasseBDConexao.abrir(); //Abre a conexão
                cmd.CommandText = "Insert Into tb_formaspagamento(DescricaoFormasPagamento,Observacoes) Values";
                cmd.CommandText += "('" + txt_descricaoformapagamento.Text + "','" + txt_obs.Text + "')";
                cmd.ExecuteNonQuery();
                cmd.Connection.Close(); //Fecha a conexão
                #endregion
            ...
            FrmPagamentoFormas_Load(sender, e);
            #endregion
        ...
        private void btn_alterar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand();
                cmd.Connection = ClasseBDConexao.abrir(); //Abre a conexão
                cmd.CommandText = "update tb_formaspagamento set DescricaoFormasPagamento ='" + txt_descricaoformapagamento.Text + "' ,Observacoes = '" + txt_obs.Text + "' Where ID = " + txt_id.Text + "";
                cmd.ExecuteNonQuery();
                cmd.Connection.Close(); //Fecha a conexão
                #endregion
        ...
        private void btn_cancelar_Click(object sender, EventArgs e)
        {
            ...
            this.lvw_formaspagamento.Enabled = true;
            #endregion
            ...
            try
            {
                string str = "Select * from tb_formaspagamento order by ID";
                string tstr = "tb_formaspagamento";
        ...
        private void txt_procurar_TextChanged(object sender, EventArgs e)
        {
            ...
            #region 'PREENCHE A LISTVIEW'
            //PROCURA OS DADOS QUE VOCÊ PREENCHEU NO TEXTBOX E SELECIONOU NO CRITÉRIO DA COMBOBOX            
            try
            {
                //string cbtexto = cbo_procurar.Text;
                string strSQL = "Select * from tb_formaspagamento " + "where " + cbo_procurar.Text + " like'%" + txt_procurar.Text + "%'";
                string tstr = "tb_formaspagamento";
                preencheListView(strSQL, tstr);
        ...
        private void lvw_formaspagamento_SelectedIndexChanged(object sender, EventArgs e)
        {
            #region 'CARREGA OS DADOS DO BANCO NA LISTVIEW'
            //CARREGA AS CAIXAS
            txt_id.Text = (lvw_formaspagamento.Items[lvw_formaspagamento.FocusedItem.Index].SubItems[0].Text);
            txt_descricaoformapagamento.Text = (lvw_formaspagamento.Items[lvw_formaspagamento.FocusedItem.Index].SubItems[1].Text);
            txt_obs.Text = (lvw_formaspagamento.Items[lvw_formaspagamento.FocusedItem.Index].SubItems[2].Text);
            #endregion
