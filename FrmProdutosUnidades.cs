...
namespace SIGRas
{
    public partial class FrmProdutosUnidades : Form
    {
        public FrmProdutosUnidades()
        {
            InitializeComponent();
        }
        ...
        private void preencheTexto(string strSql, string tstr)
        {
            ...
            datareader.Read();
            {
                ...
                txt_descricaounidade.Text = datareader["DescricaoUnidades"].ToString();
                txt_abreviacao.Text = datareader["Abreviacao"].ToString();
        ...
        private void desabilita(bool a)
        {
            #region 'DESABILITA'
            txt_id.Enabled = a;
            txt_descricaounidade.Enabled = a;
            txt_abreviacao.Enabled = a;
            txt_obs.Enabled = a;
            #endregion
        }
        #endregion
        ...
        private void FrmProdutosUnidades_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FrmProdutosUnidades_Load(object sender, EventArgs e)
        {
            #region 'CARREGAR COMBOBOX'
            this.cbo_procurar.Items.Clear();
            this.cbo_procurar.Items.Add("ID");
            this.cbo_procurar.Items.Add("DescricaoUnidades");
            this.cbo_procurar.Items.Add("Abreviacao");
            ...
            try
            {
                string strSQL = "Select * from tb_produtosunidades order by ID";
                ...
                this.txt_descricaounidade.Enabled = false;
                this.txt_abreviacao.Enabled = false;
        ...
        private void btn_novo_Click(object sender, EventArgs e)
        {
            ...
            this.txt_id.Text = "";
            this.txt_descricaounidade.Text = "";
            this.txt_abreviacao.Text = "";
            this.txt_obs.Text = "";
            this.cbo_procurar.Text = "";
            this.txt_procurar.Text = "";
            #endregion
            ...
            this.txt_id.Enabled = false;
            this.txt_descricaounidade.Enabled = true;
            this.txt_abreviacao.Enabled = true;
            this.txt_obs.Enabled = true;
            this.cbo_procurar.Enabled = false;
            this.txt_procurar.Enabled = false;
            this.lvw_unidades.Enabled = false;
            #endregion
        ...
        private void btn_gravar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (txt_descricaounidade.Text == string.Empty)
                {
                    MessageBox.Show("Preencha o campo Descrição para continuar!", "Informação", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    this.txt_descricaounidade.Focus();
                    return;
                }
                if (txt_abreviacao.Text == string.Empty)
                {
                    MessageBox.Show("Preencha o campo Abreviação para continuar!", "Informação", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    this.txt_abreviacao.Focus();
                    return;
                }
                #endregion
                ...
                cmd.Connection = ClasseBDConexao.abrir(); //Abre a conexão
                cmd.CommandText = "Insert Into tb_produtosunidades(DescricaoUnidades,Abreviacao,Observacoes) Values";
                cmd.CommandText += "('" + txt_descricaounidade.Text + "','" + txt_abreviacao.Text + "','" + txt_obs.Text + "')";
                cmd.ExecuteNonQuery();
                cmd.Connection.Close(); //Fecha a conexão
                #endregion
            ...
            FrmProdutosUnidades_Load(sender, e);
            #endregion
        ...
        private void btn_alterar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand();
                cmd.Connection = ClasseBDConexao.abrir(); //Abre a conexão
                cmd.CommandText = "update tb_produtosunidades set DescricaoUnidades ='" + txt_descricaounidade.Text + "' ,Abreviacao ='" + txt_abreviacao.Text + "' ,Observacoes = '" + txt_obs.Text + "' Where ID = " + txt_id.Text + "";
                cmd.ExecuteNonQuery();
                cmd.Connection.Close(); //Fecha a conexão
                #endregion
        ...
        private void btn_cancelar_Click(object sender, EventArgs e)
        {
            ...
            this.lvw_unidades.Enabled = true;
            #endregion
            ...
            try
            {
                string str = "Select * from tb_produtosunidades order by ID";
                string tstr = "tb_produtosunidades";
        ...
        private void txt_procurar_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string strSQL = "Select * from tb_produtosunidades " + "where " + cbo_procurar.Text + " like'%" + txt_procurar.Text + "%'";
                string tstr = "tb_produtosunidades";
                preencheListView(strSQL, tstr);
        ...
        private void lvw_unidades_SelectedIndexChanged(object sender, EventArgs e)
        {
            #region 'CARREGA AS CAIXAS SELECIONANDO O LISTVIEW'
            txt_id.Text = (lvw_unidades.Items[lvw_unidades.FocusedItem.Index].SubItems[0].Text);
            txt_descricaounidade.Text = (lvw_unidades.Items[lvw_unidades.FocusedItem.Index].SubItems[1].Text);
            txt_abreviacao.Text = (lvw_unidades.Items[lvw_unidades.FocusedItem.Index].SubItems[2].Text);
            txt_obs.Text = (lvw_unidades.Items[lvw_unidades.FocusedItem.Index].SubItems[3].Text);
            #endregion
