...
namespace SIGRas
{
    public partial class FrmNFOperacoes : Form
    {
        public FrmNFOperacoes()
        {
            InitializeComponent();
        }
        ...
        public void preencheListView(string strSql, string tstr)
        {
            ...
            try
            {
                ...
                while (datareader.Read())
                {
                    ...
                    lvw_operacoes.Items.Add(lvitem);
                }
        ...
        private void preencheTexto(string strSql, string tstr)
        {
            ...
            datareader.Read();
            {
                ...
                txt_descricaooperacao.Text = datareader["DescricaoOperacoes"].ToString();
        ...
        private void desabilita(bool a)
        {
            #region 'DESABILITA'
            txt_id.Enabled = a;
            txt_descricaooperacao.Enabled = a;
            txt_obs.Enabled = a;
            #endregion
        }
        #endregion
        ...
        private void FrmNFOperacoes_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FrmNFOperacoes_Load(object sender, EventArgs e)
        {
            #region 'CARREGA COMBOBOX'
            this.cbo_procurar.Items.Clear();
            this.cbo_procurar.Items.Add("ID");
            this.cbo_procurar.Items.Add("DescricaoOperacoes");
            ...
            try
            {
                string strSQL = "Select * from tb_nfeoperacoes order by ID";
                string tstr = "tb_nfeoperacoes";
                preencheListView(strSQL, tstr);
                preencheTexto(strSQL, tstr);
                cbo_procurar.SelectedIndex = 0;
                //DESABILITA AS CAIXAS
                this.txt_id.Enabled = false;
                this.txt_descricaooperacao.Enabled = false;
        ...
        private void btn_novo_Click(object sender, EventArgs e)
        {
            ...
            this.txt_id.Text = "";
            this.txt_descricaooperacao.Text = "";
            this.txt_obs.Text = "";
            this.cbo_procurar.Text = "";
            this.txt_procurar.Text = "";
            #endregion
        ...
        private void btn_gravar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Connection = ClasseBDConexao.abrir(); //Abre a conexão
                cmd.CommandText = "Insert Into tb_nfeoperacoes(DescricaoOperacoes,Observacoes) Values";
                cmd.CommandText += "('" + txt_descricaooperacao.Text + "','" + txt_obs.Text + "')";
                cmd.ExecuteNonQuery();
                cmd.Connection.Close(); //Fecha a conexão
                #endregion
        ...
        private void btn_alterar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand();
                cmd.Connection = ClasseBDConexao.abrir(); //Abre a conexão
                cmd.CommandText = "update tb_nfeoperacoes set DescricaoOperacoes ='" + txt_descricaooperacao.Text + "' ,Observacoes = '" + txt_obs.Text + "' Where ID = " + txt_id.Text + "";
                cmd.ExecuteNonQuery();
                cmd.Connection.Close(); //Fecha a conexão
                #endregion
        ...
        private void btn_cancelar_Click(object sender, EventArgs e)
        {
            ...
            this.lvw_operacoes.Enabled = true;
            #endregion
            ...
            #region 'PREECNHE A LISTVIEW'
            try
            {
                string str = "Select * from tb_nfeoperacoes order by ID";
                string tstr = "tb_nfeoperacoes";
        ...
        {
            #region 'VERIFICA SE A CAIXA NÃO ESTÁ VAZIA'
            ...
            try
            {
                ...
                string strSQL = "Select * from tb_nfeoperacoes " + "where " + cbo_procurar.Text + " like'%" + txt_procurar.Text + "%'";
                string tstr = "tb_nfeoperacoes";
                preencheListView(strSQL, tstr);
        ...
        private void lvw_operacoes_SelectedIndexChanged(object sender, EventArgs e)
        {
            #region 'CARREGA OS DADOS DO BANCO NA LISTVIEW'
            //CARREGA AS CAIXAS
            txt_id.Text = (lvw_operacoes.Items[lvw_operacoes.FocusedItem.Index].SubItems[0].Text);
            txt_descricaooperacao.Text = (lvw_operacoes.Items[lvw_operacoes.FocusedItem.Index].SubItems[1].Text);
            txt_obs.Text = (lvw_operacoes.Items[lvw_operacoes.FocusedItem.Index].SubItems[2].Text);
            #endregion
