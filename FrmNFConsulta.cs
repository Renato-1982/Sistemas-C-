...
namespace SIGRas
{
    public partial class FrmNFConsulta : Form
    {
        public FrmNFConsulta()
        {
            InitializeComponent();
        }
        ...
        public void preencheListView(string strSql, string tstr)
        {
            ...
            try
            {
                ...
                while (datareader.Read())
                {
                    ...
                    lvw_nfentradas.Items.Add(lvitem);
                }
                lb_totalregistros.Text = lvw_nfentradas.Items.Count.ToString();
                //lb_totalregistros.TextAlign = HorizontalAlignment.Center;
        ...
        private void FrmNFConsulta_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FrmNFConsulta_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                string strSQL = "Select * from tb_nfe order by ID";
                string tstr = "tb_nfe";
        ...
        private void txt_procurar_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string strSQL = "Select * from tb_nfe " + "where " + cbo_procurar.Text + " like'%" + txt_procurar.Text + "%'";
                string tstr = "tb_nfe";
                preencheListView(strSQL, tstr);
        ...
        private void lvw_nfentradas_SelectedIndexChanged(object sender, EventArgs e)
        {
            #region 'ATIVA/DESATIVA OS BOTÕES'
            btn_carregar.Enabled = false;
            #endregion
        ...
        private void btn_carregar_Click(object sender, EventArgs e)
        {
            ...
            frm.txt_idoperacao.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[1].Text);      
            frm.txt_descricaooperacao.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[2].Text);
            frm.txt_modelodoc.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[3].Text);
            frm.txt_especiedoc.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[4].Text);
            frm.txt_seriedoc.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[5].Text);
            frm.txt_numerodoc.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[6].Text);
            frm.txtmsk_dtemissaodoc.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[7].Text);
            frm.txtmsk_dtreferenciadoc.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[8].Text);
            ...
            frm.txt_idfornecedor.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[9].Text);
            frm.txt_descricaofornecedor.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[10].Text);
            frm.cbo_estadofornecedor.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[11].Text);
            frm.cbo_formapgdoc.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[12].Text);
            frm.cbo_prazopgdoc.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[13].Text);

            frm.txt_idproduto.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[14].Text);
            frm.txt_descricaoproduto.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[15].Text);
            frm.txt_unidadevenda.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[16].Text);
            frm.txt_precounitproduto.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[17].Text);
            frm.txt_quantidadeproduto.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[18].Text);
            frm.txt_descontoproduto.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[19].Text);
            frm.txt_acrescimoproduto.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[20].Text);
            frm.txt_vlrtotalproduto.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[21].Text);

            frm.txt_descontototaldoc.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[22].Text);
            frm.txt_acrescimototaldoc.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[23].Text);
            frm.txt_qnttotalprodutosdoc.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[24].Text);
            frm.txt_vlrtotaldoc.Text = (lvw_nfentradas.Items[lvw_nfentradas.FocusedItem.Index].SubItems[25].Text);
            #endregion
