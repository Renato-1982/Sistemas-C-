...
namespace SIGRas
{
    public partial class FrmPagamentoPrazosEntrega : Form
    {
        public FrmPagamentoPrazosEntrega()
        {
            InitializeComponent();
        }
        ...
        public void preencheListView(string strSql, string tstr)
        {
            ...
            try
            {
                ...
                while (datareader.Read())
                {
                    ...
                    lvw_prazosentrega.Items.Add(lvitem);
                }
        ...
        private void preencheTexto(string strSql, string tstr)
        {
            ...
            datareader.Read();
            {
                ...
                txt_descricaoprazoentrega.Text = datareader["DescricaoPrazosEntrega"].ToString();
        ...
        private void desabilita(bool a)
        {
            #region 'DESABILITA'
            txt_id.Enabled = a;
            txt_descricaoprazoentrega.Enabled = a;
            txt_obs.Enabled = a;
            #endregion
        }
        #endregion
        ...
        private void FrmPagamentoPrazosEntrega_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FrmPagamentoPrazosEntrega_Load(object sender, EventArgs e)
        {
            #region 'CARREGAR COMBOBOX'
            this.cbo_procurar.Items.Clear();
            this.cbo_procurar.Items.Add("ID");
            this.cbo_procurar.Items.Add("DescricaoPrazosEntrega");
            ...
            try
            {
                string strSQL = "Select * from tb_prazosentrega order by ID";
                ...
                this.txt_descricaoprazoentrega.Enabled = false;
        ...
        private void btn_novo_Click(object sender, EventArgs e)
        {
            ...
            this.txt_id.Text = "";
            this.txt_descricaoprazoentrega.Text = "";
            this.txt_obs.Text = "";
            this.cbo_procurar.Text = "";
            this.txt_procurar.Text = "";
            #endregion
            ...
            #region 'COLOCA O FOCO'
            //POSICIONA DENTRO DA CAIXA
            txt_descricaoprazoentrega.Focus();
            #endregion
        }
        ...
        private void btn_gravar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Connection = ClasseBDConexao.abrir(); //Abre a conexão
                cmd.CommandText = "Insert Into tb_prazosentrega(DescricaoPrazosEntrega,Observacoes) Values";
                cmd.CommandText += "('" + txt_descricaoprazoentrega.Text + "','" + txt_obs.Text + "')";
                cmd.ExecuteNonQuery();
                cmd.Connection.Close(); //Fecha a conexão
                #endregion
            ...
            FrmPagamentoPrazosEntrega_Load(sender, e);
            #endregion
        ...
        private void btn_alterar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand();
                cmd.Connection = ClasseBDConexao.abrir(); //Abre a conexão
                cmd.CommandText = "update tb_prazosentrega set DescricaoPrazosEntrega ='" + txt_descricaoprazoentrega.Text + "' ,Observacoes = '" + txt_obs.Text + "' Where ID = " + txt_id.Text + "";
                cmd.ExecuteNonQuery();
                cmd.Connection.Close(); //Fecha a conexão
                #endregion
        ...
        private void btn_cancelar_Click(object sender, EventArgs e)
        {
            ...
            this.lvw_prazosentrega.Enabled = true;
            #endregion
            ...
            try
            {
                string str = "Select * from tb_prazosentrega order by ID";
                string tstr = "tb_prazosentrega";
        ...
        private void txt_procurar_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string strSQL = "Select * from tb_prazosentrega " + "where " + cbo_procurar.Text + " like'%" + txt_procurar.Text + "%'";
                string tstr = "tb_prazosentrega";
                preencheListView(strSQL, tstr);
        ...
        private void lvw_prazosentrega_SelectedIndexChanged(object sender, EventArgs e)
        {
            #region 'CARREGA OS DADOS DO BANCO NA LISTVIEW'
            //CARREGA AS CAIXAS
            txt_id.Text = (lvw_prazosentrega.Items[lvw_prazosentrega.FocusedItem.Index].SubItems[0].Text);
            txt_descricaoprazoentrega.Text = (lvw_prazosentrega.Items[lvw_prazosentrega.FocusedItem.Index].SubItems[1].Text);
            txt_obs.Text = (lvw_prazosentrega.Items[lvw_prazosentrega.FocusedItem.Index].SubItems[2].Text);
            #endregion
