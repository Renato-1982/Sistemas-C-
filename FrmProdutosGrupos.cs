...
namespace SIGRas
{
    public partial class FrmProdutosGrupos : Form
    {
        public FrmProdutosGrupos()
        {
            InitializeComponent();
        }
        ...
        private void preencheTexto(string strSql, string tstr)
        {
            ...
            datareader.Read();
            {
                ...
                txt_descricaogrupo.Text = datareader["DescricaoGrupos"].ToString();
        ...
        private void FrmProdutosGrupos_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FrmProdutosGrupos_Load(object sender, EventArgs e)
        {
            #region 'CARREGAR COMBOBOX'
            this.cbo_procurar.Items.Clear();
            this.cbo_procurar.Items.Add("ID");
            this.cbo_procurar.Items.Add("DescricaoGrupos");
            ...
            try
            {
                string strSQL = "Select * from tb_produtosgrupos order by ID";
                ...
                this.txt_descricaogrupo.Enabled = false;
        ...
        private void btn_gravar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Connection = ClasseBDConexao.abrir(); //Abre a conexão
                cmd.CommandText = "Insert Into tb_produtosgrupos(DescricaoGrupos,Observacoes) Values";
                cmd.CommandText += "('" + txt_descricaogrupo.Text + "','" + txt_obs.Text + "')";
                cmd.ExecuteNonQuery();
                cmd.Connection.Close(); //Fecha a conexão
                #endregion
            ...
            FrmProdutosGrupos_Load(sender, e);
            #endregion
        ...
        private void btn_alterar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand();
                cmd.Connection = ClasseBDConexao.abrir(); //Abre a conexão
                cmd.CommandText = "update tb_produtosgrupos set DescricaoGrupos ='" + txt_descricaogrupo.Text + "' ,Observacoes = '" + txt_obs.Text + "' Where ID = " + txt_id.Text + "";
                cmd.ExecuteNonQuery();
                cmd.Connection.Close(); //Fecha a conexão
                #endregion
        ...
        private void btn_cancelar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string str = "Select * from tb_produtosgrupos order by ID";
                string tstr = "tb_produtosgrupos";
        ...
        private void txt_procurar_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string strSQL = "Select * from tb_produtosgrupos " + "where " + cbo_procurar.Text + " like'%" + txt_procurar.Text + "%'";
                string tstr = "tb_produtosgrupos";
                preencheListView(strSQL, tstr);
        ...
        private void lvw_grupos_SelectedIndexChanged(object sender, EventArgs e)
        {
            #region 'CARREGA AS CAIXAS SELECIONANDO O LISTVIEW'
            txt_id.Text = (lvw_grupos.Items[lvw_grupos.FocusedItem.Index].SubItems[0].Text);
            txt_descricaogrupo.Text = (lvw_grupos.Items[lvw_grupos.FocusedItem.Index].SubItems[1].Text);
            txt_obs.Text = (lvw_grupos.Items[lvw_grupos.FocusedItem.Index].SubItems[2].Text);
            #endregion
